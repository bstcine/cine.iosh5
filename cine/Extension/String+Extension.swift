...
/**
 * 将 String 转换为 NSString,进行特有的操作
 */
extension String {
    public var exNS :NSString {
        return self as NSString
    }
    public var pathExtention :String {
        return exNS.pathExtension
    }
    public var lastPathComponent : String{
        return exNS.lastPathComponent
    }
    public var length : Int{
        return exNS.length
    }
    public var unicodeString:String? {
        return String(bytes:self.utf8, encoding: String.Encoding.unicode)
    }
    public var utf8String:String? {
        return String(bytes: self.utf8, encoding: String.Encoding.utf8)
    }
    public var asciiString:String? {
        return String(bytes: self.utf8, encoding: String.Encoding.ascii)
    }
    public var encodeurlHost:String? {
        return self.addingPercentEncoding(withAllowedCharacters: CharacterSet.urlHostAllowed)
    }
    public var encodeurlQuery:String? {
        return self.addingPercentEncoding(withAllowedCharacters: CharacterSet.urlQueryAllowed)
    }
    public var encodeurlPath:String? {
...
extension String {
    ...
    public var isInt:Bool {
        ...
        var value:Int = 0
        let result = scan.scanInt(&value) && scan.isAtEnd
        return result
    }
    ...
    public var isFloat:Bool {
        ...
        let scan = Scanner(string: self)
        var value:Float = 0
        let result = scan.scanFloat(&value) && scan.isAtEnd
        return result
    }
    ...
    public var isDouble:Bool {
        ...
        let scan = Scanner(string: self)
        var value:Double = 0
        let result = scan.scanDouble(&value) && scan.isAtEnd
        return result
    }
    ...
    public var cgFloat:CGFloat{
        get{
            let num = self.exNS.doubleValue
            return CGFloat.init(num)
        }
    }
    public var uint:UInt{
        get{
            return UInt(self.exNS.intValue)
        }
    }
    public var int:Int{
        get{
            return Int(self.exNS.intValue)
        }
    }
    public var bool:Bool{
        get{
            return self.exNS.boolValue
        }
    }
}
...
private struct MD5 {
    ...
    fileprivate func calculate() -> [UInt8] {
